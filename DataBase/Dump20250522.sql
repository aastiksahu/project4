...
INSERT INTO `st_client` VALUES (1,615,'Sunny','2024-09-10',7772636362,'3'),(2,89474,'Deepak','2024-09-11',7467747744,'1'),(3,73633,'Parmesh','2024-09-10',8267372882,'3'),(5,55344,'Bhushan','2024-09-26',6543453673,'2'),(6,66354,'Priya','2024-09-19',7466478846,'2'),(7,66354,'Priya','2024-09-19',7466478846,'3'),(8,67455,'Eshita','2024-09-27',8887763556,'3'),(9,99836,'Kalyan','2024-09-25',998356774,'1'),(11,32442,'Vaishnavi','2024-09-08',9947455678,'3'),(12,53453,'Tejas','2024-09-15',7846674774,'2'),(13,84744,'Hansa','2024-09-27',9999983737,'3');
...
INSERT INTO `st_customer` VALUES (1,5678,'Deelip','Indore',7637386353,'2'),(2,45678,'Poonam','Pune',7877887654,'1'),(3,77134,'Kashish','Indore',8476478398,'2'),(4,65756,'Jayam','Pune',6456877656,'1'),(5,67457,'Pratik Verma','Mumbai',7836535638,'1'),(6,73563,'Kartik Verma','Pune',6355389892,'3'),(7,63467,'Jayam verma','Indore',6736779023,'2'),(8,8254,'Muskan','Ahemdabad',6745482649,'3'),(9,63256,'Harshit','Mumbai',9875563778,'2'),(10,24567,'Komal','Indore',9846367848,'2'),(11,76346,'Shreya','Indore',8465376567,'1'),(14,64567,'Shweta Verma','Bangalore',6352245678,'2'),(15,67654,'Sunny','Indore',7874678863,'3'),(16,615,'Sunny','Indore',7864628993,'3');
...
--
-- Table structure for table `st_inventory`
--

DROP TABLE IF EXISTS `st_inventory`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `st_inventory`
--

LOCK TABLES `st_inventory` WRITE;
/*!40000 ALTER TABLE `st_inventory` DISABLE KEYS */;
INSERT INTO `st_inventory` VALUES (1,'jain','2024-09-04',2,'1'),(2,'kaushal ltd','2024-09-04',5,'1'),(3,'laxmi','2024-09-17',20,'3'),(5,'jain ltd','2024-09-21',5,'2'),(6,'Shri ltd','2024-09-21',5,'2'),(7,'Ratan','2024-09-04',22,'2'),(8,'Waliya','2024-09-03',5,'1'),(9,'Vishwas','2024-09-14',35,'3'),(10,'Astha','2024-09-21',11,'1'),(11,'HariOm','2024-09-03',24,'3'),(12,'lala Ltd xyz','2024-09-28',20,'2'),(13,'gajanan','2024-09-11',10,'1'),(14,'Jai','2024-09-03',11,'1');
/*!40000 ALTER TABLE `st_inventory` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `st_position` (
  ...
  `REQUIREDEXPERIENCE` varchar(45) DEFAULT NULL,
...
INSERT INTO `st_position` VALUES (1,6754,'HR','2024-09-18','5','1'),(2,77454,'Finance','2024-09-27','3yr','2'),(3,6565,'Marketing','2024-09-25','2.4','2'),(4,53453,'Accounts','2024-09-10','3.3','1'),(5,68679,'Finance','2024-09-02','6','1'),(6,43,'Finance','2024-09-20','1','3'),(8,6667,'HR','2024-09-26','2.4','1'),(9,7837,'Finance','2024-09-27','7','1'),(10,875,'Finance','2024-09-11','9','2'),(11,7353,'Marketing','2024-09-02','1','3'),(12,8888,'Accounts','2024-09-20','2.4','1'),(14,675,'Accounts','2024-09-11','10','1');
...
CREATE TABLE `st_staff` (
  ...
  `PREVIOUSEMPLOYER` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`ID`,`IDENTIFIER`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `st_staff` WRITE;
/*!40000 ALTER TABLE `st_staff` DISABLE KEYS */;
INSERT INTO `st_staff` VALUES (1,0,'Test','2024-09-18','1','Test'),(2,0,'Testdsf','2024-09-18','2','Testfdg'),(3,0,'Testnew','2024-09-04','1','te'),(4,0,'fgdfg','2024-09-11','2','mllk'),(5,0,'hjhj','2024-09-16','2','jghj'),(6,0,'kjjjj','2024-09-19','2','ljkkljl'),(7,0,'sdfsd','2024-09-21','3','sdfs'),(8,0,'Deepak','2024-09-11','2','chedge'),(9,56787,'humanresource','2024-09-19','2','intel');
/*!40000 ALTER TABLE `st_staff` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `st_supplier`
--
...
CREATE TABLE `st_supplier` (
  ...
  `PAYMENTTERM` bigint DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `st_supplier`
--

LOCK TABLES `st_supplier` WRITE;
/*!40000 ALTER TABLE `st_supplier` DISABLE KEYS */;
INSERT INTO `st_supplier` VALUES (1,'Riya Garhwal','2','2024-09-18',7),(2,'Shruti Jain','1','2024-09-11',5),(3,'Ankit Rajpoot','3','2024-09-05',2),(4,'Shourya','2','2024-09-13',9),(5,'Kashish','1','2024-09-10',7),(6,'Yash','3','2024-09-25',10),(7,'Morya ltd','2','2024-09-03',10),(8,'Omparakash','3','2024-09-03',6),(9,'Rathore ltd','3','2024-09-10',10),(10,'Patidar ltd','2','2024-09-05',1),(11,'Soni Entprs','1','2024-09-03',5),(12,'Kailash','1','2024-09-04',8),(13,'Ekta ltd','2','2024-09-02',8),(14,'gdrddtdytd','1','2000-01-12',20000);
...
--
-- Table structure for table `st_transportation`
--

DROP TABLE IF EXISTS `st_transportation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `st_transportation` (
  `ID` bigint NOT NULL,
...
--
-- Dumping data for table `st_transportation`
--

LOCK TABLES `st_transportation` WRITE;
/*!40000 ALTER TABLE `st_transportation` DISABLE KEYS */;
INSERT INTO `st_transportation` VALUES (1,'Indore to Bhopal','2','2024-09-11',300),(2,'Pune to Indore','3','2024-09-12',6000),(3,'mumbai to indore','3','2024-09-25',10000),(4,'Indore to Bhopal','1','2024-09-18',500),(5,'Indore to Bhopal','1','2024-09-18',500),(6,'Pune to Indore','1','2024-09-26',1000),(7,'Bhopal to Indore','1','2024-09-26',1000),(8,'Mumbai to Goa','2','2024-09-09',2500),(9,'Goa to Mumbai','3','2024-09-25',2500),(10,'Delhi to  Indore','1','2024-09-19',2000),(11,'Delhi to  Indore','2','2024-09-25',1000),(12,'Delhi to  Indore','3','2024-09-28',8000),(13,'Indore to Delhi','2','2024-09-16',8000),(14,'Delhi to Dehradun','2','2024-09-16',1000);
/*!40000 ALTER TABLE `st_transportation` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `st_user` VALUES (1,'Riya','Garhwal','riyagarhwal0612@gmail.com','Riya@123','1998-06-07','9340129049',1,0,'Female',NULL,'inactive',NULL,NULL,'jainsanket153@gmail.com','jainsanket153@gmail.com','2022-06-04 14:34:31','2022-06-04 14:34:31'),(2,'Prakhar','Solanki','solankiprakhar11@gmail.com','root','2002-11-02','9977585934',1,0,'Male',NULL,'inactive',NULL,NULL,'solankiprakhar11@gmail.com','solankiprakhar11@gmail.com','2022-07-11 12:56:37','2022-07-11 12:56:37'),(5,'Bittu','Jain','bittu.jain14@gmail.com','Bittu@9977','1996-09-27','9893300972',2,0,'Male',NULL,'inactive',NULL,NULL,'jainsanket153@gmail.com','riyagarhwal0612@gmail.com','2024-08-30 13:10:48','2024-08-30 13:10:48'),(6,'Vimal','Kushwah','kushwahvimal28@gmail.com','Vimal@123','1995-07-11','7974044637',2,0,'Male',NULL,'inactive',NULL,NULL,'root','riyagarhwal0612@gmail.com','2024-08-13 23:33:20','2024-08-13 23:33:20'),(8,'Maitreyee','Kane','maitreyeekane@gmail.com','Mk@1234567','1999-07-17','8120332170',2,0,'Female',NULL,'inactive',NULL,NULL,'root','djharyani444@gmail.com','2022-10-13 14:31:20','2022-10-13 14:31:20'),(9,'Arti','Kane','artikane73@gmail.com','Ak@1234567','2022-04-27','9009426160',2,0,'Female',NULL,'inactive',NULL,NULL,'maitreyeekane@gmail.com','riyagarhwal0612@gmail.com','2024-08-13 23:39:39','2024-08-13 23:39:39'),(11,'adarsh','mukati','adarsh@gmail.com','Adarsh@123','1989-01-18','9876545678',2,0,'Male',NULL,'inactive',NULL,NULL,'djharyani444@gmail.com','djharyani444@gmail.com','2023-01-20 18:52:21','2023-01-20 18:52:32'),(12,'sumit','Meena','sumit55@gmail.com','Sumit@123','1991-01-23','9876545678',2,0,'Male',NULL,'inactive',NULL,NULL,'rajputsourabh737@gmail.com','rajputsourabh737@gmail.com','2023-01-20 23:31:27','2023-01-20 23:31:27'),(15,'sachin','verma','sachin@gmail.com','Sachin@123','1991-01-22','9669635650',2,0,'Male',NULL,'inactive',NULL,NULL,'rajputsourabh737@gmail.com','rajputsourabh737@gmail.com','2023-01-21 11:00:19','2023-01-21 11:00:19'),(16,'kapil','soni','kapil@gmail.com','Kapil@123','1992-01-21','9876545678',2,0,'Male',NULL,'inactive',NULL,NULL,'rajputsourabh737@gmail.com','rajputsourabh737@gmail.com','2023-01-21 11:14:23','2023-01-21 11:14:23'),(17,'shubhm','patel','shubham@gmail.com','Shubham@123','1983-01-25','9669635650',2,0,'Male',NULL,'inactive',NULL,NULL,'rajputsourabh737@gmail.com','rajputsourabh737@gmail.com','2023-01-21 11:17:54','2023-01-21 11:17:54'),(18,'Dhiraj','Hariyani','Dhiraj8@gmail.com','Dhiraj@123','1995-01-10','9669635650',3,0,'Male',NULL,'inactive',NULL,NULL,'rajputsourabh737@gmail.com','rajputsourabh737@gmail.com','2023-01-21 11:22:40','2023-01-21 11:22:40'),(19,'dheeru','sharma','dheeru@gmail.com','Dheeru@123','1991-01-23','9669635650',2,0,'Female',NULL,'inactive',NULL,NULL,'rajputsourabh737@gmail.com','rajputsourabh737@gmail.com','2023-01-21 11:24:22','2023-01-21 11:24:22'),(20,'raju','sharma','raju@gmail.com','Raju@123','1992-01-28','9669635650',2,0,'Male',NULL,'inactive',NULL,NULL,'rajputsourabh737@gmail.com','rajputsourabh737@gmail.com','2023-01-23 15:47:52','2023-01-23 15:47:52'),(21,'bhanu','pratap','bhanu@gmail.com','Bhanu@123','1990-01-16','9876543456',2,0,'Male',NULL,'inactive',NULL,NULL,'rajputsourabh737@gmail.com','rajputsourabh737@gmail.com','2023-01-23 23:44:10','2023-01-23 23:44:10'),(22,'ajay','Meena','ajay@gmail.com','Ajay@123','1985-01-22','9876545678',2,0,'Male',NULL,'inactive',NULL,NULL,'rajputsourabh737@gmail.com','rajputsourabh737@gmail.com','2023-01-24 11:35:07','2023-01-24 11:35:07'),(23,'sumit','pratap','sumit456@gmail.com','Sumit@1234','1989-01-11','9876543456',2,0,'Male',NULL,'inactive',NULL,NULL,'rajputsourabh737@gmail.com','rajputsourabh737@gmail.com','2023-01-24 14:25:47','2023-01-24 14:25:47'),(24,'ram','pandey','ram@gmail.com','Ram@1234','1991-01-16','9876543456',2,0,'Female',NULL,'inactive',NULL,NULL,'rajputsourabh737@gmail.com','rajputsourabh737@gmail.com','2023-01-30 00:30:05','2023-01-30 00:30:05'),(25,'anusha','jain','anusha@gmail.com','Anusha@123','1991-01-16','9876543456',2,0,'Female',NULL,'inactive',NULL,NULL,'root','root','2023-01-30 00:31:22','2023-01-30 00:31:22'),(26,'riya','agrawal','riyagarhwal06123@gmail.com','Agra@123','1990-06-07','6789766545',2,0,'Female',NULL,'inactive',NULL,NULL,'root','root','2024-06-29 12:37:16','2024-06-29 12:52:51'),(27,'riya','agrawal','riyagarhwal061234@gmail.com','Agra@123','1990-06-07','6789766545',2,0,'Female',NULL,'inactive',NULL,NULL,'root','root','2024-06-29 12:37:16','2024-06-29 12:53:04'),(28,'riya','agrawal','riyaagarhwal061234@gmail.com','Agra@123','1990-06-07','6789766545',2,0,'Female',NULL,'inactive',NULL,NULL,'root','root','2024-06-29 12:37:16','2024-06-29 12:53:17'),(29,'Shreya','singh','sh07@gmail.com','Shre@123','1991-07-03','6789942124',2,0,'Female',NULL,'inactive',NULL,NULL,'root','root','2024-07-05 20:15:14','2024-07-06 00:37:54'),(30,'Kshitij','Purohit','Kshitj@gmail.com','Kshitij@123','0018-02-18','6787656789',2,0,'Male',NULL,'inactive',NULL,NULL,'riyagarhwal0612@gmail.com','riyagarhwal0612@gmail.com','2024-12-20 11:49:15','2024-12-20 11:49:15'),(31,'mhggg','lkjhoho','uyyfy@gmail.com','Ww@123456','0018-06-18','8787654334',2,0,'Male',NULL,'inactive',NULL,NULL,'root','root','2024-12-20 11:59:24','2024-12-20 11:59:33');
...
-- Dump completed on 2025-05-22 17:06:10
